...
def main():
    ...
    # Save Data
    print('Saving Data')
    nib.save(nib.Nifti1Image(np.clip(data_norm, 0, 1), aff), PATH_OUT + 'data_norm.nii.gz')
    nib.save(nib.Nifti1Image(np.clip(data_norm_mean, 0, 1), aff), PATH_OUT + 'data_norm_mean.nii.gz')
    nib.save(nib.Nifti1Image(np.clip(data_norm_std, 0, 1), aff), PATH_OUT + 'data_norm_std.nii.gz')
