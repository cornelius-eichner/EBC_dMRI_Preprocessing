...
#FA 5 deg
cp ${NII_RAW_DIR}/*${FLASH_FA_05}P1.nii.gz ${FLASH_DIR_FA05}/data.nii.gz

#FA 12.5 deg
cp ${NII_RAW_DIR}/*${FLASH_FA_12p5}P1.nii.gz ${FLASH_DIR_FA12p5}/data.nii.gz

#FA 25 deg
cp ${NII_RAW_DIR}/*${FLASH_FA_25}P1.nii.gz ${FLASH_DIR_FA25}/data.nii.gz

#FA 50 deg
cp ${NII_RAW_DIR}/*${FLASH_FA_50}P1.nii.gz ${FLASH_DIR_FA50}/data.nii.gz

#FA 80 deg
cp ${NII_RAW_DIR}/*${FLASH_FA_80}P1.nii.gz ${FLASH_DIR_FA80}/data.nii.gz

#Highres
cp ${NII_RAW_DIR}/*${FLASH_HIGHRES}P1.nii.gz ${FLASH_DIR_HIGHRES}/data.nii.gz

#Ultra Highres
cp ${NII_RAW_DIR}/*${FLASH_ULTRA_HIGHRES}P1.nii.gz ${FLASH_DIR_ULTRA_HIGHRES}/data.nii.gz
